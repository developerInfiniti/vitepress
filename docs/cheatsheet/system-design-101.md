...
В справочнике на высоком уровне рассматриваются такие вещи, как протоколы коммуникации, DevOps, CI/CD, архитектурные паттерны, базы данных, кэширование, микросервисы (и монолиты), платежные системы, Git, облачные сервисы etc. Особую ценность представляют диаграммы - рекомендую уделить им пристальное внимание.
...
<img src="https://habrastorage.org/webt/ds/dm/vz/dsdmvzc4koavtab9wct7gowce-e.jpeg" />
<br />
...
<img src="https://habrastorage.org/webt/xd/kb/qy/xdkbqy_bh5n8rudo3twowft6huc.png" />
<br />
...
<img src="https://habrastorage.org/webt/gm/d7/yw/gmd7ywfsixqc_zwx2rvdqxjivto.jpeg" />
<br />
