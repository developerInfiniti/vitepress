...
description: Справочник по SQL
keywords: ['sql', 'structured query language', 'cheatsheet', 'справочник', 'язык структурированных запросов']
tags: ['sql', 'structured query language', 'cheatsheet', 'справочник', 'язык структурированных запросов']
---

# SQL

_Обратите внимание_: изучение данного справочника не сделает вас мастером `SQL`, но позволит получить общее представление об этом языке и возможностях, которые он предоставляет. Рассматриваемые в справочнике возможности являются общими для всех или большинства диалектов `SQL`.
...
- <a href="https://websitesetup.org/wp-content/uploads/2020/08/SQL-Cheat-Sheet-Summary-Full.png">Свежая справочник по SQL в формате PDF</a>.
