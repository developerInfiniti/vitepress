import{_ as i,c as n,o as a,ah as l}from"./chunks/framework.DwHsq7Fg.js";const g=JSON.parse('{"title":".gitignore","description":"Пример файла .gitignore","frontmatter":{"sidebar_position":15,"title":".gitignore","description":"Пример файла .gitignore"},"headers":[],"relativePath":"other/gitignore.md","filePath":"other/gitignore.md"}'),p={name:"other/gitignore.md"};function e(h,s,t,k,r,c){return a(),n("div",null,s[0]||(s[0]=[l(`<h1 id="gitignore" tabindex="-1">.gitignore <a class="header-anchor" href="#gitignore" aria-label="Permalink to “.gitignore”">​</a></h1><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">### Node ###</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">.com.apple.timemachine.donotpresent</span></span></code></pre></div>`,2)]))}const o=i(p,[["render",e]]);export{g as __pageData,o as default};
