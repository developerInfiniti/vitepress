...
const data: ResumeData = {
  ...
  projects: [
    ...
    { name: 'AI Chat Assistant', description: 'Інтерфейс для взаємодії з AI-моделями — стримінг відповідей, історія діалогів та шаблони промптів.', stack: ['TypeScript', 'Vue 3', 'OpenAI API', 'Markdown'], category: 'AI', highlights: ['Стримінг відповідей у реальному часі', 'Markdown-рендеринг', 'Експорт діалогів'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/ai-chat-assistant' }] },
    ...
    { name: 'Weather Dashboard', description: 'Панель погоди з прогнозом на 7 днів, картами та сповіщеннями про несприятливі умови.', stack: ['Vue 3', 'TypeScript', 'OpenWeather API', 'Chart.js'], category: 'Web', highlights: ['Прогноз на 7 днів', 'Геолокація', 'Графіки температури та опадів'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/weather-dashboard' }] },
    { name: 'Task Planner', description: 'Додаток для планування завдань з Pomodoro-таймером, канбан-дошкою та статистикою продуктивності.', stack: ['Vue 3', 'TypeScript', 'Pinia', 'IndexedDB'], category: 'Web', highlights: ['Pomodoro-таймер', 'Канбан-дошка', 'Офлайн-режим через IndexedDB'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/task-planner' }] },
    { name: 'Recipe Book', description: 'Книга рецептів з пошуком за інгредієнтами, калькулятором порцій та обраним.', stack: ['Vue 3', 'Firebase', 'Firestore', 'PWA'], category: 'Web', highlights: ['Пошук за інгредієнтами', 'Калькулятор порцій', 'PWA з офлайн-доступом'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/recipe-book' }] },
    { name: 'Quiz Platform', description: 'Платформа для створення та проходження тестів з таймером, статистикою та таблицею лідерів.', stack: ['Nuxt 3', 'TypeScript', 'Firebase', 'Auth'], category: 'Web', highlights: ['Конструктор тестів', 'Таблиця лідерів', 'Firebase автентифікація'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/quiz-platform' }] },
    { name: 'Invoice Generator', description: 'Генератор рахунків та інвойсів з шаблонами, PDF-експортом та історією виставлених рахунків.', stack: ['Vue 3', 'TypeScript', 'jsPDF', 'Pinia'], category: 'Web', highlights: ['PDF-генерація', 'Настроювані шаблони', 'Історія та фільтрація'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/invoice-generator' }] },
    { name: 'Photo Gallery', description: 'Галерея фотографій з lazy-loading, lightbox-переглядом та фільтрацією за альбомами.', stack: ['Vue 3', 'TypeScript', 'Cloudinary', 'CSS Grid'], category: 'Web', highlights: ['Lazy-loading зображень', 'Lightbox з жестами', 'Masonry layout'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/photo-gallery' }] },
    { name: 'Event Calendar', description: 'Календар подій з drag-and-drop, нагадуваннями та синхронізацією з Google Calendar.', stack: ['Vue 3', 'TypeScript', 'FullCalendar', 'Firebase'], category: 'Web', highlights: ['Drag-and-drop подій', 'Нагадування', 'Синхронізація з Google'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/event-calendar' }] },
    { name: 'Markdown Editor', description: 'Онлайн-редактор Markdown з попереднім переглядом, експортом в HTML/PDF та підтримкою тем.', stack: ['Vue 3', 'TypeScript', 'Marked', 'CodeMirror'], category: 'Web', highlights: ['Двопанельний редактор', 'Експорт в HTML/PDF', 'Підсвітка синтаксису'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/markdown-editor' }] },
    { name: 'Screen Recorder', description: 'Десктоп-додаток для запису екрану з можливістю анотацій та експорту в GIF/MP4.', stack: ['Electron', 'Vue 3', 'FFmpeg', 'Canvas API'], category: 'Desktop', highlights: ['Запис екрану та камери', 'Анотації в реальному часі', 'Експорт в GIF/MP4'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/screen-recorder' }] },
    { name: 'Color Picker Pro', description: 'Розширення для вибору кольорів з веб-сторінок з палітрами, історією та форматами (HEX, RGB, HSL).', stack: ['Vue.js', 'Chrome Extensions API', 'Canvas API'], category: 'Extensions', highlights: ['Піпетка зі збільшенням', 'Історія кольорів', 'Генерація палітр'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/color-picker-pro' }] },
    { name: 'URL Shortener', description: 'Сервіс скорочення URL з аналітикою кліків, кастомними alias та QR-кодами.', stack: ['Node.js', 'Express', 'MongoDB', 'QRCode'], category: 'Backend', highlights: ['Кастомні короткі посилання', 'Аналітика кліків', 'Генерація QR-кодів'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/url-shortener' }] },
    { name: 'File Upload Service', description: 'Мікросервіс завантаження файлів з валідацією, ресайзом зображень та S3-сховищем.', stack: ['Node.js', 'Express', 'Multer', 'Sharp', 'AWS S3'], category: 'Backend', highlights: ['Валідація типів та розмірів', 'Автоматичний ресайз', 'S3 інтеграція'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/file-upload-service' }] },
    { name: 'Habit Tracker', description: 'Мобільний додаток для відстеження звичок з ланцюжками, нагадуваннями та статистикою.', stack: ['Vue 3', 'Capacitor', 'TypeScript', 'SQLite'], category: 'Mobile', highlights: ['Ланцюжки звичок', 'Push-сповіщення', 'Статистика за місяць/рік'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/habit-tracker' }] },
    { name: 'Expense Tracker', description: 'Трекер витрат з категоризацією, бюджетами, графіками та експортом в CSV.', stack: ['Vue 3', 'Capacitor', 'Chart.js', 'Firebase'], category: 'Mobile', highlights: ['Категорії витрат', 'Графіки та аналітика', 'Експорт в CSV'], links: [{ label: 'GitHub', url: 'https://github.com/AlexeyZelenko/expense-tracker' }] },
  ],
